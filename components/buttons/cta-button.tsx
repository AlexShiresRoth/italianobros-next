...
const altLinkClassNames =
  "px-4 py-4 border-2 text-sm md:text-base uppercase font-sans font-semibold border-primary bg-transparent text-white hover:bg-primary hover:text-white dark:bg-transparent dark:text-white transition-colors dark:hover:bg-primary ";
